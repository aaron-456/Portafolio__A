         ...
         <section className='container__contactame' ref={contactameRef} id='C'>
            ...
            <form className='form__contactame' action="https://formspree.io/f/xyyaabye" method="POST">
               ...
               <label className='box_label' htmlFor="email">
                  Correo Electronico:
                  <input className='box__input' type="email" id="email" name="email" />
               </label>
               <label className='box_label' htmlFor="message">
                  Mensaje:
                  <textarea className='box__message' id="message" name="message"></textarea>
               </label>
